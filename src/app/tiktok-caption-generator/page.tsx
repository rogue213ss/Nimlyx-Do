...
const tool = getToolBySlug("tiktok-caption-generator");

export const metadata: Metadata = tool ? buildToolMetadata(tool, "/tiktok-caption-generator/") : {};

export default function Page() {
  if (!tool) return notFound();
  const category = getCategoryBySlug(tool.category);
  const path = "/tiktok-caption-generator/";
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mt-14 max-w-prose" aria-labelledby="how-it-works">
        ...
        <p className="mt-2 text-ink/70">
          Type what your video is about and get a few short, punchy caption options, each paired
          with a small, relevant hashtag set sized for TikTok convention.
        </p>
      </section>
