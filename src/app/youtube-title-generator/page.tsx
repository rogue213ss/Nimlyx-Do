...
export const metadata: Metadata = tool ? buildToolMetadata(tool, "/youtube-title-generator/") : {};

export default function Page() {
  if (!tool) return notFound();
  const category = getCategoryBySlug(tool.category);
  const path = "/youtube-title-generator/";
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mt-14 max-w-prose" aria-labelledby="how-it-works">
        ...
        <p className="mt-2 text-ink/70">
          Type your video&apos;s topic, pick a style, and get several title ideas built from common,
          proven title structures. Use them as a starting point and adjust to match your voice.
        </p>
      </section>
