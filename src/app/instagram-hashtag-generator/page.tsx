...
const tool = getToolBySlug("instagram-hashtag-generator");

export const metadata: Metadata = tool ? buildToolMetadata(tool, "/instagram-hashtag-generator/") : {};

export default function Page() {
  if (!tool) return notFound();
  const category = getCategoryBySlug(tool.category);
  const path = "/instagram-hashtag-generator/";
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mt-14 max-w-prose" aria-labelledby="how-it-works">
        ...
        <p className="mt-2 text-ink/70">
          Type a topic or keyword and get a relevant, deduped set of hashtags — built from your
          own words plus a curated bank matched to common topic categories. Nothing is invented
          or random.
        </p>
      </section>
