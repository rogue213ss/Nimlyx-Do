...
export const metadata: Metadata = tool ? buildToolMetadata(tool, "/instagram-caption-generator/") : {};

export default function Page() {
  if (!tool) return notFound();
  const category = getCategoryBySlug(tool.category);
  const path = "/instagram-caption-generator/";
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mt-14 max-w-prose" aria-labelledby="how-it-works">
        ...
        <p className="mt-2 text-ink/70">
          Type what your post is about, pick a tone, and get a few caption options built from
          curated templates — plus matching hashtags. Use them as a starting point to edit and
          make your own.
        </p>
      </section>
