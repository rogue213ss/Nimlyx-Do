...
export const metadata: Metadata = tool ? buildToolMetadata(tool, "/youtube-description-generator/") : {};

export default function Page() {
  if (!tool) return notFound();
  const category = getCategoryBySlug(tool.category);
  const path = "/youtube-description-generator/";
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mt-14 max-w-prose" aria-labelledby="how-it-works">
        ...
        <p className="mt-2 text-ink/70">
          Type your video&apos;s topic and list a few key points (one per line). You&apos;ll get a
          formatted description with an intro line, bulleted key points, and optional hashtags
          and a subscribe line.
        </p>
      </section>
      ...
      <section className="mt-12 max-w-prose" aria-labelledby="privacy">
        ...
        <p className="mt-2 text-ink/70">
          Your topic and key points are processed entirely on your device. Nothing is ever sent
          over the network.
        </p>
      </section>
