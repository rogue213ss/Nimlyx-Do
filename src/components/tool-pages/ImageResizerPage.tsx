    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <section className="mt-14 max-w-prose" aria-labelledby="how-it-works">
        ...
        <p className="mt-2 text-ink/70">
          Select a JPG, PNG, or WebP image and its current dimensions appear
          automatically. Enter a target width or height — with the aspect
          ratio locked, the other dimension updates for you — then resize
          and download. Everything happens locally in your browser.
        </p>
      </section>
      ...
      <section className="mt-12 max-w-prose" aria-labelledby="privacy">
        ...
        <p className="mt-2 text-ink/70">
          Your image is processed entirely on your device. It never leaves
